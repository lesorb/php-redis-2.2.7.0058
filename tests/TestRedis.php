...
//    }
    ...
    public function testGetMasterByKey() {
        $_master_servers = array( 
              array( 'master' => '192.168.32.243:7000', ),
              array( 'master' => '192.168.32.242:7000', ), 
              array( 'master' => '192.168.32.241:7000', ),
            );
        $ret = $this->redis->getMasterByKey('test', $_master_servers);
		
		$this->assertTrue(is_numeric($ret) <= 2);
